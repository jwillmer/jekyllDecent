...
13. 9번 파일있는 위치에서 core-site.xml 수정
...
14. 9번 파일있는 위치에서 hdfs-site.xml 수정
...
```
 ...
 15. 9번 파일있는 위치에서 mapred-site.xml 수정
...
<configuration>
 ...
 16. 9번 파일있는 위치에서 yarn-site.xml 수정
 ...
 * ###### 어려움2
  >하둡은 현재 기준으로 하둡1,2,3이 나왔으며, 각 버전마다 환경 설정이나 파일들이 많이 달라진다. 현업(우리회사)에서는 2.X를 많이 사용하여 2버전을 설치 해놓고 1에 대한 설정 책을 읽다가 시간 허비를 많이 하였다. 부디 세팅 방법이나 책이 몇 버전인지 확인하고 시작하자!  ^ㅡ^
